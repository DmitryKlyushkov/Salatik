        ...
        <main class="main">
          ...
          <section class="about">
            ...
            <?php
              ...
              preg_match_all("/[A-Za-zА-Яа-я]+\s([А-Яа-я]?)+/imu", $meta_ingredients, $ingredients_names );
              preg_match_all("/(?<=\()(.*?)(?=\))/m", $meta_ingredients, $ingredients_numbers );
                      
              $meta_calories = trim( get_post_meta( $post_id, 'calories', true ) );
              preg_match_all("/[A-Za-zА-Яа-я]+\s([А-Яа-я]?)+/imu", $meta_calories, $calories_names );
              ...
              $avatar = get_avatar( $post_author_id, 96, 'mystery', '', '' );
                            ...
                            foreach ($ingredients_names[0] as $key => $value): ?>
                              ...
                              <div class="ingredients__row">
                                <div class="ingredients__ingredient">
                                  ...
                                  <?php echo $ingredients_names[0][$key]; ?>

                                </div>
                                <div class="ingredients__amount">

                                  <?php echo $ingredients_numbers[0][$key] ?>
