...
function salatik_get_breadcrumbs() {

	$text['home']       = esc_html__('Главная','salatik');
	$text['category']   = esc_html__('Archive','salatik').' "%s"';
	$text['search']   	 = esc_html__('Search results','salatik').' "%s"';
	$text['tag']      	 = esc_html__('Tag','salatik').' "%s"';
	$text['author']   	 = esc_html__('Author','salatik').' %s';
	$text['404']      	 = esc_html__('Error 404','salatik');
